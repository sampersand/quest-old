...
pub(super) struct Attributes {
	assigned: SyncMap<AttrId, QObject>,
...
impl From<QObject> for AttrId {
	#[inline]
	fn from(obj: QObject) -> AttrId {
...
impl Attributes {
	...
	pub(super) fn set<I: Into<AttrId>>(&self, id: I, val: QObject) -> Option<QObject> {
		self.assigned.set(id.into(), val)
	}

	pub(super) fn get<I: Into<AttrId>>(&self, id: I, caller: &QObject) -> Option<QObject> {
		let id = id.into();
	...
	pub fn del<I: Into<AttrId>>(&self, id: I) -> Option<QObject> {
