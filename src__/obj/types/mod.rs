...
pub trait Type : Debug + Display + Eq + Hash + Send + Sync + 'static where Object<Self>: HasDefaults {}
// pub trait Type : Debug + Display + Eq + Hash + Send + Sync + 'static where Object<Self>: HasDefaults {}

impl<T: Debug + Display + Eq + Hash + Send + Sync + 'static> Type for T where Object<T>: HasDefaults {}
